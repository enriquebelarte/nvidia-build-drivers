FROM registry.distributed-ci.io/dtk/driver-toolkit:5.14.0-284.57.1.el9_2 as builder

ARG ARCH='x86_64'
ARG DRIVER_VERSION='535.86.10'
ARG DRIVER_EPOCH='1'
ARG KERNEL_VERSION='5.14.0-284.57.1.el9_2'
